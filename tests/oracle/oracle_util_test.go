...
// sslConfig mirrors the ssl block of the driver's source.json.
type sslConfig struct {
	Mode string `json:"mode,omitempty"`
}

// connectionString mirrors the oracle driver's Config.connectionString.
func (c *sourceConfig) connectionString() string {
	...
	if c.SSLConfiguration != nil {
		sslmode := c.SSLConfiguration.Mode
		if sslmode != "disable" {
			urlOptions["ssl"] = "true"
